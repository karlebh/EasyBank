<template>
  ...
  <div class="mx-auto text-center px-4 pb-16 mt-5">
   <h1 style="color: hsl(233, 26%, 24%); font-size: 2.67rem;line-height: 3.2rem;" class="">Next generation digital banking</h1>
   <p class="mt-3 text-gray-400">Take your financial life online. Your EasyBank account will be a one-shop-step from spending, saving, budgeting, investin and much more.</p>
 ...
 <section class="mx-auto text-center px-4 bg-gray-200 py-16">
   <div class="max-w-lg mx-auto">
    <h1 style="color: hsl(233, 26%, 24%); font-size: 2.67rem;line-height: 3.2rem;" class="">Why choose Easybank?</h1>
    <p class="mt-3 text-gray-400">We levarage Open Banking to turn your bank account into your financial hub. Control your finances like never before.</p>
  </div>
...
<section class="py-24">
 <h1 class="text-center font-sans text-4xl mb-10">Latest Articles</h1>

 <div class="grid md:grid-cols-2 md:px-10 gap-y-10">
  <Card 
...
<script>
    ...
    data() {
      return {
        image: "~@/assets/images/image-mockups.png"
      }
    },
    components: {
     Card,
